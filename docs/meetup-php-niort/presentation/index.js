    ...
    render() {
        return (
            <Deck
                ...
                progress="bar"
                contentWidth={1440}>
                <Slide align={'center center'} bgColor={'#F4F6F8'}>
                ...
                <Slide align={'center center'}>
                    ...
                    <Text style={{ fontSize: 48 }}>
                        <Link
                            href={'https://welcomattic.github.io/traduire-efficacement-une-app-symfony/meetup-php-niort/index.html'}
                            style={{ fontSize: 48 }}>
                            Slides
                        </Link>
                        &nbsp;/&nbsp;
